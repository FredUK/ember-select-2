...
var Select2Component = Ember.Component.extend({
  ...
  attributeBindings: ["style", "tabindex", 'ariaHidden:aria-hidden', 'ariaLabel:aria-label', 'title', 'ariaLabel:label'],
  ariaHidden: 'true',
  title: null,
  ...
  didInsertElement: function() {
    ...
    options.closeOnSelect = !this.get('keepOpen');
    ...
    function() {
      ...
      if (select) {
        Ember.run.next(function() {
          if (select.select2("readonly") !== disabled) {
